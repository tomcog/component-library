    ...
    >
      ...
      <Section
        ...
        note={
          ...
          + "segment has none, and hovering one lights a pale action tint under it \u2014 pale enough to "
          + "read as the pointer rather than as a second thing chosen, which the selected segment\u2019s "
          + "full-strength ground still owns. The selected pill is flush with the "
